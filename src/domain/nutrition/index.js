// Domain: Nutrition — BMR, TDEE, calorie deficit, macros
// Pure functions only. No DOM, Vue, localStorage, IndexedDB dependencies.

import { MIN_CALORIES_FEMALE, MIN_CALORIES_MALE } from '../meal-plan/constants.js'
...
export function calculateTargetCalories(params) {
  ...
  const minCalories = params.gender === 'female' ? MIN_CALORIES_FEMALE : MIN_CALORIES_MALE
