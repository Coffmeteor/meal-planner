...
const profileRows = computed(() => {
  ...
  return [
    ...
    { label: '目标热量', value: formatValue(profile.targetCalories || props.planMeta?.targetCalories, 'kcal') },
    { label: '饮食类型', value: dietMethodLabels[profile.dietMethod || props.planMeta?.dietMethod] || '--' },
