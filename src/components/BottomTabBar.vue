...
const iconPaths = {
  ...
  profile: 'M12 12c2.21 0 4-1.79 4-4s-1.79-4-4-4-4 1.79-4 4 1.79 4 4 4zM4 20c0-4.42 3.58-8 8-8s8 3.58 8 8',
}
</script>
...
<template>
  <nav class="bottom-tab-bar" aria-label="主导航">
    ...
    >
      <svg class="tab-icon" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.6" stroke-linecap="round" stroke-linejoin="round">
